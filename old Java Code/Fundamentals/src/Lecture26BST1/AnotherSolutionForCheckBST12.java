...
public class AnotherSolutionForCheckBST12 {
	...
	public static isBSTReturn isBST2(BinaryTreeNode3<Integer> root) {
		if(root == null) {
	...
	public static boolean isBST3(BinaryTreeNode3<Integer> root ,int minRange,int maxRange) {
		if(root == null) {
			return true;
		}
		...
		boolean isLeftWithinRanger =  isBST3(root.left, minRange, root.data-1);
		boolean isRightWithinRanger =  isBST3(root.left, root.data, maxRange); 
		
		return isLeftWithinRanger && isRightWithinRanger;
	}
...
//		System.out.print(root,30);
		...
		System.out.print(ans.min + " " + ans.max + " " + ans.isBST);
