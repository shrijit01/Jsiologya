...
import Lecture26BST1.isBSTReturn;

public class RootToNodePathInBinaryTree1 {
	...
	//Lecture 1 BST 2
	public static ArrayList<Integer> nodeToRootPath(BinaryTreeNode3<Integer>root,int x){
		if(root == null) {
			return null;
		}
