...
public class BuildTreeUsingInorderAndPreOrder14 {
	...
	//Lecture 14 build tree using pre and in order
	public static BinaryTreeNode3<Integer> buildTreePreIn(int[] pre,int[] in){
		BinaryTreeNode3<Integer> root = buildTreePreInHelper(pre,in,0,pre.length-1,0,in.length-1);
		return root;
	}
	
	
	
	private static BinaryTreeNode3<Integer> buildTreePreInHelper(int[] pre, int[] in, int siPre, int eiPre, int siIn,int eiIn) {
		...
		BinaryTreeNode3<Integer> left = buildTreePreInHelper(pre, in, siPreLeft, eiPreLeft, siInLeft, eiInLeft);
		BinaryTreeNode3<Integer> right = buildTreePreInHelper(pre, in, siPreRight, eiPreRight, siInRight, eiInRight);
...
//		Lecture 14+++++++++++++++++++++++++++++++++
		...
		BinaryTreeNode3<Integer> root = buildTreePreIn(pre, in);
